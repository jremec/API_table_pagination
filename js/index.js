$(document).ready(function(){
  ...
  function successCallback(response){
    ...
    $("#example-table").tabulator({
          ...
          {title:"producer", field:"producer", align:"center", width:"20"},
          {title:"brand_id", field:"brand_id", align:"center", width:"20"},
          {title:"master_id", field:"master_id", align:"center", width:"20"},
          {title:"select_id", field:"select_id", align:"center", width:"20"},
